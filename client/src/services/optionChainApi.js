...
/**
 * Fetch stored OHLCV history for the underlying (index/stock), for the
 * Strategy Builder's "Underlying Chart" tab. Reads ohlcv_data only — see
 * server/routes/optionChain.js's /:symbol/underlying-history.
 */
